...
import { Plus, List, Search, ArrowLeft, Info, Edit2, History, FileStack, X } from 'lucide-react'
...
export default function PurchaseEntryPage() {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50 dark:bg-zinc-900">
            ...
            {/* Action Bar */}
            <div className="sticky top-0 md:top-[44px] z-10 bg-white dark:bg-zinc-900 border-b dark:border-zinc-800 px-3 py-2 shadow-sm flex flex-wrap items-center justify-between md:justify-start gap-4">
                {/* Left: Purchase List Buttons - Hidden on mobile */}
                <div className="hidden md:flex items-center gap-2">
                    ...
                    <Link
                        ...
                        className="flex items-center gap-1 px-3 py-1.5 text-sm bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 hover:bg-purple-200 dark:hover:bg-purple-900/50 rounded transition-colors"
                    >
                        <List size={16} />
                        All Purchase List
                    </Link>
                ...
                <div className="flex items-center gap-2 w-full md:w-auto">
                    ...
                    {/* Add Button - Hidden on mobile (moved to global header) */}
                    <button
