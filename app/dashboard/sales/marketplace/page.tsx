...
export default function MarketplaceSalesMenuPage() {
    const menuItems = [
        {
            name: 'Sales Entry',
            icon: Package,
        ...
        },
        {
            ...
            icon: FileText,
            href: '/dashboard/sales/marketplace/update-status',
            color: 'bg-blue-500'
        },
        {
        ...
        },
        {
            name: 'Order Sync',
            icon: RefreshCw,
            href: '/dashboard/sales/marketplace/order-sync',
            color: 'bg-indigo-500'
        },
        {
            name: 'Sales Report',
            icon: TrendingUp,
            href: '/dashboard/sales/marketplace/report',
            color: 'bg-purple-500'
        }
    ]
                        ...
                        return (
                            <Link key={item.name} href={item.href}>
                                <Card className="p-3 hover:shadow-lg transition-all cursor-pointer h-full border border-gray-400 dark:border-zinc-600 bg-gray-200 dark:bg-zinc-800 flex flex-col items-center justify-center gap-2 text-center">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-xs text-gray-800 dark:text-gray-100">{item.name}</h3>
                                    </div>
                                </Card>
                            </Link>
                        )
