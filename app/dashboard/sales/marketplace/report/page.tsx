    ...
    return (
        <div className="flex flex-col h-full bg-gray-50 dark:bg-zinc-900">
            ...
            <div className="bg-white dark:bg-zinc-900 border-b dark:border-zinc-800 px-4 py-3 shadow-md sticky top-0 z-10 flex items-center justify-between">
                <div>
                    <h1 className="text-lg font-bold">Marketplace Sales Report</h1>
                    <p className="text-xs text-gray-500 dark:text-gray-400">Detailed sales reports and analytics</p>
                </div>
                <Link
            ...
            <div className="flex-1 flex items-center justify-center p-8">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                        This page is under development. Detailed sales reporting and analytics will be available soon.
                    </p>
                </div>
            </div>
        </div>
